	...
	client.on('message-new', async (mek) => {
		try {
			...
			mess = {
				...
				only: {
					group: '❬❗❭ 𝗔𝗣𝗘𝗡𝗔𝗦 𝗗𝗢𝗡𝗢 𝗗𝗢 𝗚𝗥𝗨𝗣𝗢 ',
					ownerG: '❬❗❭ 𝗔𝗣𝗘𝗡𝗔𝗦 𝗗𝗢𝗡𝗢 𝗗𝗢 𝗚𝗥𝗨𝗣𝗢 ',
					ownerB: '❬❗❭  𝗔𝗣𝗘𝗡𝗔𝗦 𝗗𝗢𝗡𝗢 𝗗𝗢 𝗚𝗥𝗨𝗣𝗢 ',
					admin: '❬❗❭ 𝗔𝗣𝗘𝗡𝗔𝗦 𝗗𝗢𝗡𝗢 𝗗𝗢 𝗚𝗥𝗨𝗣𝗢 ',
          ...
          case 'ping':
			...
			case 'loli': 
				    try {
						...
						console.log(`Error :`, color(e,'red'))
						reply(' falhei num comando tao incrivel... me desculpe ')
					}
					break
				case 'nsfwloli': 
				    try {
